...
export const InvalidQuantityException = new BadRequestException('Error.SKU.InvalidQuantity')

export const NotFoundCartItemException = new BadRequestException('Error.CartItem.NotFound')
